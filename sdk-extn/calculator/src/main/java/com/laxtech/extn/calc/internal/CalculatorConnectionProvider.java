 ...
 */
public class CalculatorConnectionProvider implements PoolingConnectionProvider<CalculatorConnection> {
  ...
  */
  ...
  public CalculatorConnection connect() throws ConnectionException {
    return new CalculatorConnection(requiredParameter + ":" + optionalParameter);
  }
  ...
  @Override
  public ConnectionValidationResult validate(CalculatorConnection connection) {
